...
public class Main {
	...
	public static void main(String[] args) {
		...
		String email = "carolina.trindade@univille.br";
		String senha = "1234";

		Usuario usuario = usuarioDao.getByEmail(email);
		
		// Caso não encontre o usuário no banco de dados, cria um novo usuário
		//System.out.println(usuario.toString());
		
		if (usuario == null) {
			
			Usuario novoUsuario = new Usuario(email, "Carolina Trindade", senha);
			...
			// Verifica se o novo usuário foi criado
		...
		Tarefa tarefa2 = new Tarefa(2, "Comprar maçãs", data, false, 1, projeto);
		...
		// Exbe a lista de tarefas do usuário
		...
		// Exbe a lista de tarefas do usuário atualizada
		
		listaTarefasUsuario = tarefaDao.getTarefasUsuario(usuario);
		
		System.out.println("\nLista atualizada de tarefas do usuário: ");
